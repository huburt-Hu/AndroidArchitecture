...
import com.huburt.app.entity.Reply;
import com.huburt.app.entity.Summary;
...
public interface VideoDetailService {
    ...
    Call<Summary> getSummaryData(@Query("aid") String aid);
    ...
    Call<Reply> getReplyData(@Query("oid") String oid, @Query("pn") int pn, @Query("ps") int ps);
    ...
    Call<PlayUrl> getPlayurl(@Query("aid") String aid);//&aid=15813368
}